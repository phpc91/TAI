...
<link rel="stylesheet" href="/TAI/resources/getmdl-select/getmdl-select.min.css" />
<script defer src="/TAI/resources/getmdl-select/getmdl-select.min.js"></script>
...
<body>
	...
	<div class="container" style="width:300px">
		...
		<form method="post" action="${pageContext.request.contextPath}/orcamento" accept-charset="UTF-8" style="text-align:center"> <!-- form action? -->
			<div>
				<h6 title="" style="text-align:center">Valor da conta de luz:</h6> 
				...
				<input class="mdl-textfield mdl-js-textfield mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="valorNumero" min="10" max="1000" value="500" oninput="this.form.valorSlider.value=this.value" style="text-align:center;width:128px;margin:auto" />
				<!-- <label class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" for="valorNumero">R$</label> -->
			...
			<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="pFisica">
				<input type="radio" id="pFisica" class="mdl-radio__button" name="options" value="1" checked> 
				<span class="mdl-radio__label">Pessoa Física</span>
			</label>&emsp;&emsp;
			
			<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="pJuridica">
				<input type="radio" id="pJuridica" class="mdl-radio__button" name="options" value="2"> 
				<span class="mdl-radio__label">Pessoa Jurídica</span>
			</label>

			<br><br>
			<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" type="button" onclick="location.href='/TAI'" name="voltar"> <!-- style="position:absolute;left:525px;"> -->
